...
if(!((function (){var G__21515 = app_db;
if(G__21515){
...
return G__21515.reagent$ratom$IReactiveAtom$;
}
})())){
return true;
} else {
if((!G__21515.cljs$lang$protocol_mask$partition$)){
return cljs.core.native_satisfies_QMARK_.call(null,reagent.ratom.IReactiveAtom,G__21515);
} else {
return false;
}
}
...
return re_frame.middleware.path.cljs$core$IFn$_invoke$arity$variadic(argseq__18889__auto__);
});

re_frame.middleware.path.cljs$core$IFn$_invoke$arity$variadic = (function (args){
var path = cljs.core.flatten.call(null,args);
var _ = ((cljs.core.empty_QMARK_.call(null,path))?re_frame.utils.error.call(null,"re-frame: \"path\" middleware given no params."):null);
...
re_frame.middleware.path.cljs$lang$applyTo = (function (seq21520){
return re_frame.middleware.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq21520));
});
/**
 ...
 * 
 */
re_frame.middleware.on_changes = (function re_frame$middleware$on_changes(){
var argseq__18889__auto__ = ((((2) < arguments.length))?(new cljs.core.IndexedSeq(Array.prototype.slice.call(arguments,(2)),(0))):null);
return re_frame.middleware.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__18889__auto__);
});

re_frame.middleware.on_changes.cljs$core$IFn$_invoke$arity$variadic = (function (f,out_path,in_paths){
return (function re_frame$middleware$on_changed_middleware(handler){
return (function re_frame$middleware$on_changed_middleware_$_on_changed_handler(db,v){
var new_db = handler.call(null,db,v);
var new_ins = cljs.core.map.call(null,((function (new_db){
return (function (p1__21521_SHARP_){
return cljs.core.get_in.call(null,new_db,p1__21521_SHARP_);
});})(new_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,new_ins){
return (function (p1__21522_SHARP_){
return cljs.core.get_in.call(null,db,p1__21522_SHARP_);
});})(new_db,new_ins))
,in_paths);
...
re_frame.middleware.on_changes.cljs$lang$applyTo = (function (seq21523){
...
return re_frame.middleware.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__21524,G__21525,seq21523__$2);
});

//# sourceMappingURL=middleware.js.map?rel=1432392088176